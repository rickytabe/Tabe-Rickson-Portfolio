export const SECTION_STYLES = {
  ...
  backdropText: "text-[18vw] md:text-[12vw] font-black font-mono text-white/2 tracking-tighter whitespace-nowrap uppercase leading-none",

  // The small "01 --- Section Name" pre-header style
  headerBadgeWrapper: "flex items-center gap-4 font-mono text-sm md:text-lg tracking-[0.2em] text-[#39FF14] mb-6", 
  headerBadgeNumber: "font-bold text-sm md:text-xl",
  headerBadgeLine: "w-10 h-px bg-[#39FF14]/50",
  headerBadgeText: "text-white/50 uppercase font-semibold text-sm md:text-xl",
